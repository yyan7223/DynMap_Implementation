set moduleName CurOptPotentialPlacement_List_BypassLess_Gen_Pipeline_VITIS_LOOP_470_5
set isTopModule 0
...
set C_modelName {CurOptPotentialPlacement_List_BypassLess_Gen_Pipeline_VITIS_LOOP_470_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ i int 7 regular  }
	{ potentialPlacement_AllPreds int 4 regular {array 160 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ i sc_in sc_lv 7 signal 0 } 
	{ potentialPlacement_AllPreds_address0 sc_out sc_lv 8 signal 1 } 
	{ potentialPlacement_AllPreds_ce0 sc_out sc_logic 1 signal 1 } 
	{ potentialPlacement_AllPreds_q0 sc_in sc_lv 4 signal 1 } 
...
set Spec2ImplPortList { 
	...
	potentialPlacement_AllPreds { ap_memory {  { potentialPlacement_AllPreds_address0 mem_address 1 8 }  { potentialPlacement_AllPreds_ce0 mem_ce 1 1 }  { potentialPlacement_AllPreds_q0 in_data 0 4 } } }
