set moduleName RoutingAvailability_CheckPredecessor_and_Placement_Pipeline_VITIS_LOOP_32_1
set isTopModule 0
...
set C_modelName {RoutingAvailability_CheckPredecessor_and_Placement_Pipeline_VITIS_LOOP_32_1}
set C_modelType { int 1 }
set C_modelArgList {
	{ bypassPreds_load int 8 regular  }
	{ phi_ln32_out int 7 regular {pointer 1}  }
	{ trunc_ln32_2_cast_out int 7 regular {pointer 1}  }
	{ placement_dynamic_dict_Opt2Tile_keys int 8 regular {array 100 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bypassPreds_load", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "phi_ln32_out", "interface" : "wire", "bitwidth" : 7, "direction" : "WRITEONLY"} , 
 	{ "Name" : "trunc_ln32_2_cast_out", "interface" : "wire", "bitwidth" : 7, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bypassPreds_load sc_in sc_lv 8 signal 0 } 
	{ phi_ln32_out sc_out sc_lv 7 signal 1 } 
	{ phi_ln32_out_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ trunc_ln32_2_cast_out sc_out sc_lv 7 signal 2 } 
	{ trunc_ln32_2_cast_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bypassPreds_load", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "bypassPreds_load", "role": "default" }} , 
 	{ "name": "phi_ln32_out", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "phi_ln32_out", "role": "default" }} , 
 	{ "name": "phi_ln32_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "phi_ln32_out", "role": "ap_vld" }} , 
 	{ "name": "trunc_ln32_2_cast_out", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "trunc_ln32_2_cast_out", "role": "default" }} , 
 	{ "name": "trunc_ln32_2_cast_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "trunc_ln32_2_cast_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	bypassPreds_load { ap_none {  { bypassPreds_load in_data 0 8 } } }
	phi_ln32_out { ap_vld {  { phi_ln32_out out_data 1 7 }  { phi_ln32_out_ap_vld out_vld 1 1 } } }
	trunc_ln32_2_cast_out { ap_vld {  { trunc_ln32_2_cast_out out_data 1 7 }  { trunc_ln32_2_cast_out_ap_vld out_vld 1 1 } } }
