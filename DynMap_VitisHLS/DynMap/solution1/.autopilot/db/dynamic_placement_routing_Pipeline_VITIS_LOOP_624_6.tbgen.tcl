set moduleName dynamic_placement_routing_Pipeline_VITIS_LOOP_624_6
set isTopModule 0
...
set C_modelName {dynamic_placement_routing_Pipeline_VITIS_LOOP_624_6}
set C_modelType { int 1 }
set C_modelArgList {
	{ j_3_reload int 4 regular  }
	{ add_ln619 int 10 regular  }
	{ zext_ln608 int 6 regular  }
	{ dependency_predecessor_values int 8 regular {array 1000 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "j_3_reload", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln619", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln608", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ j_3_reload sc_in sc_lv 4 signal 0 } 
	{ add_ln619 sc_in sc_lv 10 signal 1 } 
	{ zext_ln608 sc_in sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "j_3_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "j_3_reload", "role": "default" }} , 
 	{ "name": "add_ln619", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "add_ln619", "role": "default" }} , 
 	{ "name": "zext_ln608", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln608", "role": "default" }} , 
...
set Spec2ImplPortList { 
	j_3_reload { ap_none {  { j_3_reload in_data 0 4 } } }
	add_ln619 { ap_none {  { add_ln619 in_data 0 10 } } }
	zext_ln608 { ap_none {  { zext_ln608 in_data 0 6 } } }
