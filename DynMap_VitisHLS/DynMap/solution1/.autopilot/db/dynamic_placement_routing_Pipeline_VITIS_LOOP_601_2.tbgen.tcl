set moduleName dynamic_placement_routing_Pipeline_VITIS_LOOP_601_2
set isTopModule 0
...
set C_modelName {dynamic_placement_routing_Pipeline_VITIS_LOOP_601_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln602 int 10 regular  }
	{ i_out int 4 regular {pointer 1}  }
	{ dependency_predecessor_values int 8 regular {array 1000 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln602", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "i_out", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add_ln602 sc_in sc_lv 10 signal 0 } 
	{ i_out sc_out sc_lv 4 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln602", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "add_ln602", "role": "default" }} , 
 	{ "name": "i_out", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "i_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln602 { ap_none {  { add_ln602 in_data 0 10 } } }
	i_out { ap_vld {  { i_out out_data 1 4 }  { i_out_ap_vld out_vld 1 1 } } }
