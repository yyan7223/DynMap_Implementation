set moduleName Dependency_Update_BypassMode_SrcTgt_Pipeline_VITIS_LOOP_116_9
set isTopModule 0
...
set C_modelName {Dependency_Update_BypassMode_SrcTgt_Pipeline_VITIS_LOOP_116_9}
set C_modelType { int 1 }
set C_modelArgList {
	{ add_ln117 int 11 regular  }
	{ bypassSrcOpt_load int 8 regular  }
	{ add_ln117_1_out int 11 regular {pointer 1}  }
	{ dependency_successor_values int 8 regular {array 2000 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln117", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "bypassSrcOpt_load", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln117_1_out", "interface" : "wire", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add_ln117 sc_in sc_lv 11 signal 0 } 
	{ bypassSrcOpt_load sc_in sc_lv 8 signal 1 } 
	{ add_ln117_1_out sc_out sc_lv 11 signal 2 } 
	{ add_ln117_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ dependency_successor_values_address0 sc_out sc_lv 11 signal 3 } 
	{ dependency_successor_values_ce0 sc_out sc_logic 1 signal 3 } 
	{ dependency_successor_values_q0 sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln117", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "add_ln117", "role": "default" }} , 
 	{ "name": "bypassSrcOpt_load", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "bypassSrcOpt_load", "role": "default" }} , 
 	{ "name": "add_ln117_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "add_ln117_1_out", "role": "default" }} , 
 	{ "name": "add_ln117_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add_ln117_1_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	add_ln117 { ap_none {  { add_ln117 in_data 0 11 } } }
	bypassSrcOpt_load { ap_none {  { bypassSrcOpt_load in_data 0 8 } } }
	add_ln117_1_out { ap_vld {  { add_ln117_1_out out_data 1 11 }  { add_ln117_1_out_ap_vld out_vld 1 1 } } }
