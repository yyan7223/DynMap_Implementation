set moduleName CurOptPotentialPlacement_List_BypassLess_Gen_Pipeline_VITIS_LOOP_577_16
set isTopModule 0
...
set C_modelName {CurOptPotentialPlacement_List_BypassLess_Gen_Pipeline_VITIS_LOOP_577_16}
set C_modelType { int 1 }
set C_modelArgList {
	{ existLen_2_reload int 7 regular  }
	{ zext_ln577 int 4 regular  }
	{ curOptPotentialPlacement int 5 regular {array 16 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "existLen_2_reload", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln577", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ existLen_2_reload sc_in sc_lv 7 signal 0 } 
	{ zext_ln577 sc_in sc_lv 4 signal 1 } 
	{ curOptPotentialPlacement_address0 sc_out sc_lv 4 signal 2 } 
	{ curOptPotentialPlacement_ce0 sc_out sc_logic 1 signal 2 } 
	{ curOptPotentialPlacement_q0 sc_in sc_lv 5 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "existLen_2_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "existLen_2_reload", "role": "default" }} , 
 	{ "name": "zext_ln577", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln577", "role": "default" }} , 
...
set Spec2ImplPortList { 
	existLen_2_reload { ap_none {  { existLen_2_reload in_data 0 7 } } }
	zext_ln577 { ap_none {  { zext_ln577 in_data 0 4 } } }
