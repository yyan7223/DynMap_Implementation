...
module runOne_Reset_Pipeline_VITIS_LOOP_707_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln707_fu_56_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln707_fu_56_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln707_fu_62_p2 = (ap_sig_allocacmp_i + 7'd1);
...
endmodule //runOne_Reset_Pipeline_VITIS_LOOP_707_14
