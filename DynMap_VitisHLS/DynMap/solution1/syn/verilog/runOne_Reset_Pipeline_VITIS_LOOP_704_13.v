...
module runOne_Reset_Pipeline_VITIS_LOOP_704_13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln705_3_fu_110_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln705_fu_120_p1;
reg   [5:0] i_15_fu_38;
wire   [5:0] i_18_fu_94_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i;
wire   [9:0] zext_ln705_2_fu_100_p1;
wire   [9:0] add_ln705_fu_104_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln704_fu_88_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln704_fu_88_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln705_fu_104_p2 = (mul_ln725 + zext_ln705_2_fu_100_p1);
...
assign i_18_fu_94_p2 = (ap_sig_allocacmp_i + 6'd1);

assign icmp_ln704_fu_88_p2 = ((ap_sig_allocacmp_i == DFG_NodesCount_kernels_values_load) ? 1'b1 : 1'b0);

assign placement_dynamic_dict_Opt2PC_keys_address0 = zext_ln705_fu_120_p1;

assign placement_dynamic_dict_Opt2PC_keys_d0 = placement_static_kernels_values_q0;

assign placement_static_kernels_values_address0 = zext_ln705_3_fu_110_p1;

assign zext_ln705_2_fu_100_p1 = ap_sig_allocacmp_i;

assign zext_ln705_3_fu_110_p1 = add_ln705_fu_104_p2;

assign zext_ln705_fu_120_p1 = i_reg_136;

endmodule //runOne_Reset_Pipeline_VITIS_LOOP_704_13
