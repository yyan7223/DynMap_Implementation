...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "runOne.autotvin.dat"
	set constFileTvOut       "runOne.autotvout.dat"
	set constFileHdlTvIn     "runOne.autohdltvin.dat"
	set constFileHdlTvOut    "runOne.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
