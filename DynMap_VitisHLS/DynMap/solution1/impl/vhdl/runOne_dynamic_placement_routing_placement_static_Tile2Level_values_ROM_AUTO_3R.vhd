...
entity runOne_dynamic_placement_routing_placement_static_Tile2Level_values_ROM_AUTO_3R is 
    generic(
             DataWidth     : integer := 2; 
...
architecture rtl of runOne_dynamic_placement_routing_placement_static_Tile2Level_values_ROM_AUTO_3R is 

signal address0_t1_tmp : std_logic_vector(AddressWidth-1 downto 0); 
type mem_array is array (0 to AddressRange-1) of std_logic_vector (DataWidth-1 downto 0); 
signal mem : mem_array := (
    0 to 3=> "00", 4 to 11=> "01", 12 to 15=> "10" );
