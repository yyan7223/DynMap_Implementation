...
entity runOne_lshr_113ns_32ns_113_7_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 113;  --data bitwidth
      din1_WIDTH : INTEGER := 113;    --shift control bitwidth
      dout_WIDTH : INTEGER := 113;  --output bitwidth
...
end entity runOne_lshr_113ns_32ns_113_7_1;
architecture rtl of runOne_lshr_113ns_32ns_113_7_1 is
