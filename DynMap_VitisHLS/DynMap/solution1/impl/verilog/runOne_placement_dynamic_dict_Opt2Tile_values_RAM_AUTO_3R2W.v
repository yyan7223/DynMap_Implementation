...
// ==============================================================
`timescale 1 ns / 1 ps
module runOne_placement_dynamic_dict_Opt2Tile_values_RAM_AUTO_3R2W (address0, ce0, d0, we0, q0,  reset,clk);
...
initial begin
    $readmemh("./runOne_placement_dynamic_dict_Opt2Tile_values_RAM_AUTO_3R2W.dat", ram);
end
