...
int bpsStride[3][2] = {{1, 1}, // x move 1, y move 1
...
static map<int, int> placement_static_Tile2Level_MorphoSys = { // 4x4 CGRA
    {5, 0}, // All Tiles have 6 Links
    {6, 0},
    {9, 0},
    {10, 0},
    {1, 0}, 
...
static map<int, int> placement_static_Tile2Level_HReA = { // 4x4 CGRA
    {5, 0}, // Tile 5,6,9,10, level 0
    {6, 0},
    {9, 0},
    {10, 0},
...
static map<int, int> placement_static_Tile2Level_HyCube = { // 4x4 CGRA
    {5, 0}, // All Tiles can communicate within 1 cycle
    {6, 0},
    {9, 0},
    {10, 0},
    {1, 0}, 
...
static map<string, map<string, vector<string>>> dependency_pseudo_predecessors_kernels = {
    // mvt
    {"mvt", {
        {"fcmp0", {}}, 
        {"and1", {}}, 
