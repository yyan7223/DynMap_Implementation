...
REM
REM Generated by Vivado on Sun Dec 17 19:08:35 +0800 2023
...
echo "xvlog --incr --relax -prj BypassLessUnit_tb_vlog.prj"
call xvlog  --incr --relax -prj BypassLessUnit_tb_vlog.prj -log xvlog.log
