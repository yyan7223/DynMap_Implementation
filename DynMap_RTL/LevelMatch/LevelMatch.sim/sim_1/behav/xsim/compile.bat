...
REM
REM Generated by Vivado on Sun Dec 17 16:38:57 +0800 2023
...
echo "xvlog --incr --relax -prj LevelMatchUnit_tb_vlog.prj"
call xvlog  --incr --relax -prj LevelMatchUnit_tb_vlog.prj -log xvlog.log
